...
<div class="container subpage-container">
    ...
    <div class="subpage-content">
        <img src="img/dos.jpg" alt="<?= htmlspecialchars($foro_titulo) ?>" class="subpage-image">
        <h2 class="subpage-title"><?= htmlspecialchars($foro_titulo) ?></h2>
        <p class="subpage-info"><h2>Autor - Santiago García-Clairac</h2></p>

        <form method="post">
            <ul class="subpage-features">
                <li>
                    <strong>Pregunta 1: ¿Qué tema principal crees que aborda la historia y por qué es importante?</strong>
                    <textarea name="respuestas[Pregunta 1]" placeholder="Escribe tu respuesta aquí..."></textarea>
                </li>
                <li>
                    <strong>Pregunta 2: ¿Qué personaje te llamó más la atención y por qué?</strong>
