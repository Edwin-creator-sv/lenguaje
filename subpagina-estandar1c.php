...
$foro_titulo = 'Supervivencia extrema'; // Cambiar según subpágina
...
<div class="container subpage-container">
    ...
    <div class="subpage-content">
        <img src="img/supervivencia-extrema.jpg" alt="<?= htmlspecialchars($foro_titulo) ?>" class="subpage-image">
        <h2 class="subpage-title"><?= htmlspecialchars($foro_titulo) ?></h2>
        <p class="subpage-info"><h2>Autor - Arturo Padilla</h2></p>

        <form method="post">
            <ul class="subpage-features">
                <li>
                    <strong>Pregunta 1: ¿Qué te enseñó esta historia sobre la amistad y el trabajo en equipo?</strong>
                    <textarea name="respuestas[Pregunta 1]" placeholder="Escribe tu respuesta aquí..."></textarea>
                </li>
                <li>
                    <strong>Pregunta 2: ¿Qué escena del libro te impactó más y por qué?</strong>
